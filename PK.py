...
TOKEN = '7829836113:AAEw4z1bIAcf0Zlaf87KcJnLmbEwrOEZgsM'  # Replace with your actual bot token
ADMIN_IDS = [8179218740]  # Added new admin ID
CHANNEL_ID = '-1002625393217'  # Replace with your specific channel or group ID
# Initialize the bot
...
def welcome_start(message):
    ...
    bot.send_message(
            message.chat.id,
            f"👋🏻Welcome {user_name}.\n\n"
            f"[➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖](https://t.me/+QHK2q5RK9VpkY2E1)\n\n"    
    ...
    bot.send_message(
            message.chat.id,
            f" [➖𝗗𝗠 𝗙𝗢𝗥 𝗥𝗘𝗕𝗥𝗔𝗡𝗗𝗜𝗡𝗚➖](https://t.me/SIDIKI_MUSTAFA_92)\n\n                                                      ↖️",
    parse_mode="Markdown",
    disable_web_page_preview=True  # This disables the link preview
    )
...
def info(message):
    info_text = (
        "ℹ️ *Bot Information*\n\n"
        "Version: 3.0\n"
        "Developed And Design by: @SIDIKI_MUSTAFA_92🗿\n"
...
def shutdown(message):
    ...
    if user_id != OWNER_ID:
        bot.reply_to(message, "🚫 HA BHAI TU KREGA BOT KO SHUTDOWN😂 BHAG JAA .")
        return
...
def reset_attack_limit(message):
    owner_id = 8179218740  # Replace with the actual owner ID
    if message.from_user.id != owner_id:
        response = (
            "❌🚫 *ABE TU KAREGA RESET😂 BHAG JAA!* 🚫❌\n\n"
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [DEVELOPER_OF_BOT](https://t.me/SIDIKI_MUSTAFA_92) ⚡*"
    )
...
FEEDBACK_CHANNEL_ID = "-1002575291262"  # Replace with your actual feedback channel ID
